...
//                        "<h3>" + locale.locale.image.insert + "</h3>" +
//                        "</div>" +
...
//                        "<a href='#' class='btn' data-dismiss='modal'>" + locale.locale.image.cancel + "</a>" +
//                        "</div>" +
//                        "</div>" +
//                        "<a class='btn btn-default' data-wysihtml5-command='insertImage' title='" + locale.locale.image.insert + "'><i class='glyphicon glyphicon-picture'></i></a>" +
//                        "</li>";
//            }
//        }
    };
